var ElectionResult = (function (exports) {
  'use strict';
  ...
  */
  ...
  var __vue_render__$2 = function() {
    ...
    var _c = _vm._self._c || _h;
    return _c("article", [
      _c("p", [_vm._v("Begin typing a constituency name")]),
      _vm._v(" "),
      _c("input", {
        directives: [
          {
  ...
  __vue_render__$5._withStripped = true;
    ...
    const __vue_inject_styles__$5 = function (inject) {
      if (!inject) return
      inject("data-v-0d603ee7_0", { source: "\nol[data-v-0d603ee7] {\n  display: flex;\n}\nli[data-v-0d603ee7] {\n  padding-bottom: 0.5em;\n  box-sizing: border-box;\n}\na[data-v-0d603ee7] {\n  padding: 0.5rem;\n  border-radius: 10px 10px 0 0;\n  background: #c1002a;\n  color: #fff;\n  margin-right: 0.25em;\n}\n.router-link-active[data-v-0d603ee7] {\n  background: #e2001a;\n}\n", map: {"version":3,"sources":["/Users/gilesdring/src/odileeds/election2019/update-election-data/src/components/navigation.vue"],"names":[],"mappings":";AAUA;EACA,aAAA;AACA;AACA;EACA,qBAAA;EACA,sBAAA;AACA;AACA;EACA,eAAA;EACA,4BAAA;EACA,mBAAA;EACA,WAAA;EACA,oBAAA;AACA;AACA;EACA,mBAAA;AACA","file":"navigation.vue","sourcesContent":["<template>\n  <nav>\n    <ol>\n      <li><router-link :to=\"{ name: 'home' }\" exact>Home</router-link></li>\n      <li><router-link :to=\"{ name: 'search' }\">Locate</router-link></li>\n      <li><router-link :to=\"{ name: 'live-map' }\">Live Map</router-link></li>\n    </ol>\n  </nav>\n</template>\n<style scoped>\nol {\n  display: flex;\n}\nli {\n  padding-bottom: 0.5em;\n  box-sizing: border-box;\n}\na {\n  padding: 0.5rem;\n  border-radius: 10px 10px 0 0;\n  background: #c1002a;\n  color: #fff;\n  margin-right: 0.25em;\n}\n.router-link-active {\n  background: #e2001a;\n}\n</style>"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$5 = "data-v-0d603ee7";
    /* module identifier */
  ...
  function init(_ref) {
    ...
    return regeneratorRuntime.async(function init$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            constituencyData = _ref.constituencyData;
            _context.next = 3;
            return regeneratorRuntime.awrap(Promise.all([get$1(constituencyData)]));
